...
<!-- Body Content Start -->
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <form class="mt-3" action="<?=base_url('Institute/Home/profile')?>" method="post">
                ...
                <div class="col-lg-6 col-md-6">
                    <form class="mt-3" method="post" action="<?=base_url('Institute/Home/profile')?>">
            ...
            <form class="mt-1 border-top" method="post" action="<?=base_url('Institute/Home/profile')?>" >
                <div class="row mt-2">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo form_input([
                                ...
                                'name'=>'u_firstName','value'=>set_value('u_firstName', $user->u_firstName),
                                'autocomplete'=>'off'
                            ])?>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo form_input([
                                ...
                                'name'=>'u_lastName','value'=>set_value('u_lastName', $user->u_lastName),
                                'autocomplete'=>'off'
                            ])?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <button type="submit" name="others" class="btn btn-primary float-right">
        ...
        <div class="col-lg-3 col-md-12 col-sm-12">
            <form class="mt-3 modifyInstitute border-left" method="post" action="<?=base_url('Institute/Home/modifyPass')?>">
                <div class="row ml-3">
